...
function TooltipInfo({ texto }) {
  ...
  return (
    <>
      <i className="doc-info-icon" data-tooltip-id={id} data-tooltip-place="top">i</i>
...
export default function NuevaFactura() {
  ...
  const opcionesProductos = (idx) => productos.map(p => ({
    value: p.id,
      ...
      <form onSubmit={e => { setSubmitIntentado(true); handleSubmit(e); }}>
        ...
        <div className="doc-pago-totales">
          ...
          <div className="doc-totales">
            ...
            {totales.totalIVA > 0 && (
              <div className="doc-totales-fila">
                <span>IVA:</span><span>{fmt(totales.totalIVA)}</span>
              </div>
            )}
            {totales.totalINC > 0 && (
              <div className="doc-totales-fila">
                <span>INC:</span><span>{fmt(totales.totalINC)}</span>
              </div>
            )}
            <div className="doc-totales-fila">
              <span>RetelCA:</span>
