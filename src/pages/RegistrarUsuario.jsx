...
function RegistrarUsuario() {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      direccionNegocio: usuario.direccionNegocioUsuario,
      departamentoNegocio: usuario.departamentoNegocioUsuario,
      ciudadNegocio: usuario.ciudadNegocioUsuario,
    ...
    setUsuario((prev) => ({
      ...prev,
      departamentoNegocioUsuario: e.target.value,
      ciudad: "",
    }));
  };
            ...
            <div style={estilos.campo}>
             <label className="form-label">Ciudad o Municipio</label>
                  <select
                    ...
                    onChange={handleChange}
                    required
                    disabled={!usuario.departamentoNegocioUsuario}
                  >
                    <option value="">Seleccionar ciudad</option>
                    {(ciudades[usuario.departamentoNegocioUsuario] || []).map((ciudad) => (
