...
export default function NuevaNotaDebito() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setSaving(true);
      await axiosClient.post("/NotasDebito", payload);
      alert("Nota débito creada exitosamente");
      navigate("/ventas");
    } catch (err) {
      alert("Error al crear nota débito: " + err.message);
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="doc-container">
      ...
      <div className="doc-titulo-row">
        <h4 className="doc-titulo">Nueva nota débito</h4>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="doc-header-grid" style={{ marginTop: 12 }}>
          ...
          <div className="doc-col">
            ...
            <div className="doc-field">
              <label className="doc-label">
                Factura origen *
                <TooltipInfo texto="Selecciona la factura a la que se incrementará el valor." />
              </label>
              <Select
          ...
          <div className="doc-col">
            ...
            <div className="doc-field">
              ...
              <div className="doc-comprobante-inputs">
                ...
                <input type="text"
                  ...
                  value="" placeholder="Auto" readOnly />
              </div>
            </div>
            ...
            <div className="doc-field">
              ...
              <input type="text" className="form-control form-control-sm"
                value={notaDebito.cufe} readOnly
        ...
        <div className="doc-pago-totales">
          ...
          <div className="doc-totales">
            <div className="doc-totales-fila"><span>Total Bruto:</span><span>{fmt(totales.totalBruto)}</span></div>
            <div className="doc-totales-fila">
              <span>Descuentos:</span>
              <span className="text-danger">-{fmt(totales.totalDescuentos)}</span>
            </div>
            <div className="doc-totales-fila"><span>Subtotal:</span><span>{fmt(totales.subtotal)}</span></div>
            {totales.totalIVA > 0 && (
            ...
            <div className="doc-totales-fila">
              ...
              <div className="doc-retelca-row">
                <input
                  ...
                  onChange={(e) => setNotaDebito((p) => ({ ...p, retelCA: e.target.value }))}
                  placeholder="0"
                />
        ...
        <div className="doc-footer">
          ...
          <button type="submit" className="doc-btn-guardar-enviar" disabled={saving}>
            {saving ? "Guardando..." : "Guardar nota débito"}
          </button>
        </div>
      </form>
    </div>
