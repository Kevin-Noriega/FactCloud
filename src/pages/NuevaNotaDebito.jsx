    ...
    setProductosSeleccionados((prev) => {
      ...
      if (campo === "productoId") {
        ...
        if (prod) {
          ...
          nuevos[idx].precioUnitario =
            prod.precioVenta || prod.precioUnitario || 0;
              ...
              <div className="doc-col">
                ...
                <div className="doc-field">
                  ...
                  <Select
                    ...
                    value={
                      opcionesFacturas.find(
                        (o) => o.value === notaDebito.facturaId,
                      ) ?? null
                    }
                    onChange={(opt) => {
                    ...
                    noOptionsMessage={({ inputValue }) => (
                      <NoOptionsFactura inputValue={inputValue} />
                    )}
                    isClearable
                  ...
                  {mostrarError("facturaId") && !notaDebito.facturaId && (
                    <small
                      style={{ color: "var(--doc-red)", fontSize: "0.78rem" }}
                    >
                  ...
                  {facturaSeleccionada && (
                    ...
                    >
                      Cliente:{" "}
                      <strong>{facturaSeleccionada.cliente?.nombre}</strong>
                      {" · "}Total:{" "}
                      <strong>${fmt(facturaSeleccionada.totalFactura)}</strong>
                      {" · "}Estado:{" "}
              ...
              <div className="doc-col">
                ...
                <div className="doc-field">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNotaDebito((p) => ({ ...p, vendedor: e.target.value }))
                    }
