        ...
        <div className="row mb-3">
          ...
          <div className="col-md-4">
            ...
            <Select
              ...
              onChange={(opt) => handleSelectChange("tipoIdentificacion", opt?.value ?? "")}
              isClearable
          ...
          <div className="col-md-4">
            ...
            <Select
              ...
              onChange={(opt) => handleSelectChange("regimenTributario", opt?.value ?? "")}
              isClearable
        ...
        <div className="row mb-3">
          ...
          <div className="col-md-6">
            ...
            <Select
              ...
              onChange={(opt) => handleSelectChange("regimenFiscal", opt?.value ?? "")}
              isClearable
        ...
        <div className="row mb-3">
          ...
          <div className="col-md-6">
            ...
            <Select
              ...
              onChange={(opt) => handleSelectChange("actividadEconomicaCIIU", opt?.value ?? "")}
              isClearable
          ...
          <div className="row mb-2 align-items-end" key={i}>
            ...
            <div className="col-md-2">
              <input className="form-control" placeholder="Apellido"
                value={c.apellido}
                onChange={(e) => handleContactoChange(i, "apellido", e.target.value)} />
            </div>
            <div className="col-md-3">
              <input className="form-control" placeholder="Correo electrónico"
                value={c.correo}
                onChange={(e) => handleContactoChange(i, "correo", e.target.value)} />
            </div>
            <div className="col-md-2">
