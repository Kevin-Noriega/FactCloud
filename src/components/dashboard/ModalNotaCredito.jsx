  ...
  return (
    <>
     <div className={`panel-backdrop ${open ? 'show' : ''}`} onClick={onClose} />
      <div className="modal-nota-overlay" onClick={onClose} />
       <div 
        ref={panelRef}
        className={`panel-nota-content ${open ? 'open' : ''}`}
      >
      <div className="panel-notac-header">
        ...
        <div className="panel-nota-body">
          <form onSubmit={handleSubmit}>
            ...
            <div className="panel-nota-footer">
