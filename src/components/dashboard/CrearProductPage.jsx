  ...
  return (
    ...
    <div className="page-crear-producto">
      ...
      <div className="page-crear-producto__header">
        <div className="page-crear-producto__titulo">
          <button
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="row mb-3">
            ...
            <div className="col-md-4">
              ...
              {errores.codigoUNSPSC && (
                <div className="invalid-feedback">{errores.codigoUNSPSC}</div>
              )}
            </div>
            {!producto.esServicio && (
              <div className="col-md-4">
          ...
          <div className="row mb-3">
            <div className="col-md-3">
              ...
              />
              {errores.baseGravable && (
                <div className="invalid-feedback">{errores.baseGravable}</div>
              )}
            </div>
            <div className="col-md-3">
            ...
            <div className="col-md-3">
              ...
              <input
                ...
                placeholder="Ej: 15"
              />
              {errores.retencionIVA && (
                <div className="invalid-feedback">{errores.retencionIVA}</div>
              )}
              <small className="text-muted">
            ...
            <div className="col-md-3">
              ...
              <input
                ...
                placeholder="Ej: 6.9"
              />
              {errores.retencionICA && (
                <div className="invalid-feedback">{errores.retencionICA}</div>
              )}
              <small className="text-muted">
          ...
          <div className="row mb-3">
            ...
            <div className="col-md-4">
              ...
              {errores.precioUnitario && (
                <div className="invalid-feedback">{errores.precioUnitario}</div>
              )}
            </div>
            <div className="col-md-4">
          ...
          <div className="row mb-3">
            ...
            {producto.gravaINC && (
              <div className="col-md-4">
                ...
                />
                {errores.tarifaINC && (
                  <div className="invalid-feedback">{errores.tarifaINC}</div>
                )}
              </div>
            )}
          </div>
